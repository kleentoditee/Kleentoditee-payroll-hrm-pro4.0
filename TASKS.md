...
| Finance Core | Claude | `agent/claude/finance-core` | `C:\dev\kleentoditee-worktrees\claude-finance-core` | finance API/UI, finance models, export/report logic | In progress — Phase 3 Task 9 (finance master data) |
...
| --- | --- | --- | --- |
| `packages/db/prisma/schema.prisma` | Claude / finance-core | Adding finance master-data models (Account, Customer, Supplier, Product) for Phase 3 Task 9 | Locked |
| `package.json` / `package-lock.json` | None | Dependencies/scripts | Free |
| `apps/api/src/app.ts` | Claude / finance-core | Mounting `/finance/*` routes for Phase 3 Task 9 | Locked |
