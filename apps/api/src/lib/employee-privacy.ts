...
export function toDetailPayload(
  ...
  return {
    ...
    bankAccountNumber: expose ? emp.bankAccountNumber : maskIdentifier(emp.bankAccountNumber),
    bankTransitNumber: expose ? emp.bankTransitNumber : maskIdentifier(emp.bankTransitNumber),
